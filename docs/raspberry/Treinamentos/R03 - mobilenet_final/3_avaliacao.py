...
import os
import shutil
# --- MUDANÇA 1: Remover a importação desnecessária do ResNet ---
...
# --- MUDANÇA 2: Usar o nome do arquivo correto do modelo MobileNet ---
MODEL_PATH = "meu_modelo_mobilenet.keras" 

# --- MUDANÇA 3: Remover 'custom_objects' ao carregar o modelo ---
