...
# --- MUDANÇA 1: Importar o MobileNetV2 ---
...
# --- MUDANÇA 2: Usar uma camada de normalização simples (Rescaling) ---
# Em vez da função do ResNet, normalizamos os pixels para o intervalo [0, 1]
x = Rescaling(1./255)(inputs)
# --- FIM DA MUDANÇA 2 ---

x = data_augmentation(x)

# --- MUDANÇA 3: Usar o MobileNetV2 como modelo base ---
...
model.save('meu_modelo_mobilenet.keras')
print("\nModelo treinado com MobileNetV2 e salvo com sucesso!")
